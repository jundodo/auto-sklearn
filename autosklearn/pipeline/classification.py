...
class SimpleClassificationPipeline(BasePipeline, ClassifierMixin):
    ...
    def _get_hyperparameter_search_space(
        ...
        metric_name = CategoricalHyperparameter(
        "classifier:reject_option_classifier:metric_name",
        ["Statistical parity difference", "Average odds difference", "Equal opportunity difference"],
        default_value="Statistical parity difference"
    )
        cs.add_hyperparameter(metric_name)
